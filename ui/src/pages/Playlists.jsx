...
function Playlists() {
  ...
  /**
   * Here I'm navigating to different page if it's favorites playlist,
   * because this one is special and it's not stored in the API.
   */
  ...
  return (
    ...
    >
      ...
      {error ? (
        <p>Error loading playlists...</p> // Show error message
      ) : isPending ? (
